...
> See the repository-wide pinned library versions for the exact versions this project has been verified against.

---

## Build and Flash Instructions

1. Install ESP32 board support in Arduino IDE (`Tools → Board → Boards Manager`, search "esp32", install **ESP32 by Espressif Systems**, version **2.0.17**).
