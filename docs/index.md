...
| [BLE 3-Touch Interface](ble-3-touch-interface.html) | The touch-sensor parallel of the 3-switch interface — no mechanical switches, just three TTP223 touch sensors (left/middle/right) | 3 capacitive touch sensors | LEFT_ARROW, ENTER, RIGHT_ARROW |
...
1. Pick the project that matches your needs — the [full 11-input node](ble-adaptive-switch-expanded-scaffold.html), the [3-switch controller](ble-3-switch-interface.html), or the [3-touch controller](ble-3-touch-interface.html) — and open its page for the complete pinout and wiring diagram.
