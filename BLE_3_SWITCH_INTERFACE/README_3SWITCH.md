...
This matches your rule exactly: the lowest-numbered GPIO is the physically left switch and sends `LEFT_ARROW`; the middle GPIO is the physically middle switch and sends `ENTER`; the highest-numbered GPIO is the physically right switch and sends `RIGHT_ARROW`.
...
3. Open `BLE_3SWITCH_ARROW_ENTER.ino`.
